...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-3xl mx-auto p-6 py-20">
      <h1 className="text-3xl font-bold mb-4">Mobile App Privacy Policy</h1>
      ...
      <p className="mb-4">
        <strong>Visitor Data:</strong> We do not collect information about your visit to Proboard
      </p>
